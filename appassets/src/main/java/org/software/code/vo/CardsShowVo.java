...
public class CardsShowVo {
    ...
    @Schema(description = "银行卡类型名，对应 type：1=储蓄卡，2=信用卡", example = "储蓄卡")
    private String typeName;

    @Schema(description = "是否为默认卡：1=默认，2=非默认", example = "1")
    private Integer status;

    @Schema(description = "卡号尾号，用于展示（自动生成字段）", example = "8888")
